...
const BMICalculator: React.FC<BMICalculatorProps> = ({ height, weight, targetWeight }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
